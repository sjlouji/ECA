...
class CreateSelectionListsTableV1 extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('selection_lists_table_v1', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('selection_lists_table_v1');
    }
}
