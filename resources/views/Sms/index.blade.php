                ...
                <section class="content">
                    <div class="box box-default">
                        <div class="box-header with-border">
                            <h3 class="box-title">Sms Controller</h3>
                            @can('isAdmin')
                                <button onclick="window.open('{{url('/sms/add')}}')" type="button" class="btn btn-block btn-primary btn-normal" style="float:right;width:150px"><span class="fa fa-plus"></span> Add Template </button>
                            @endcan
                        </div>
                        <div class="box-body">
         ...
         {{-- <script typetype="text/javascript">
            $(document).ready(function(){
                        var table = $('#example1').DataTable({
                            ...
                            "columns":[
                                {"data":"calit_or_non_dalit", "name":"application_no"},
					            {"data":"poor_or_not_poor", "name":"year_of_addmission"},
					            {"data":"student_name", "name":"student_name"},
                                {"data":"cut_off", "name":"cut_off"},
					            {"data":"catholic_or_non_catholic", "name":"catholic_or_non_catholic"},
					            {"data":"religion", "name":"religion"},
					            {"data":"choice_1", "name":"board"},
					            {"data":"choice_2", "name":"caste"},
                                {"data":null,
