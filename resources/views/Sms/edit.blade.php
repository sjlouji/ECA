                                    ...
                                    <tr class="form-group">
                                            ...
                                            <td>
                                                <div class="row">
                                                    ...
                                                    <input name="template_name" id="template_name" type="text" required='required' placeholder="Enter Department Name" value="{{$template->template_name}}" class="validate[required] text-input form-control" />
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        <tr class="form-group">
                                            ...
                                            <td>
                                                <div class="row">
                                                    <div class="col-xs-6 form-input">
                                                            <textarea name="message" rows="10" cols="30" name="placeholder_text" id="placeholder_text" class="validate[required] text-input form-control">{{ $template->message }}</textarea>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>         
                                        ...
                                        <table width="100%">
                                            <tr>
                                                <td align="center">
                                                    ...
                                                    <input type="button" value="Cancel" class="btn btn-secondary" title="Cancel" id="cancel" onclick="window.location='{{url('/sms')}}'">
                                                </td>
                                            </tr>
                                        </table>
                                    </div>
